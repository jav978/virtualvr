...
const Workflow = () => {
    return (
        <div className="mt-20">
            <h2 className="mt-16 text-3xl dark:text-white tracking-wide text-center sm:text-5xl md:text-6xl mb-6">
                Accelarate your{" "}
            ...
            <div className="flex flex-wrap justify-items-center">
                <div className="w-full p-2 lg:w-1/2 rounded-md">
                ...
                <div className="w-full pt-12 lg:w-1/2">
                    {checklistItems.map((item, index) => (
                        <div key={index} className="flex mb-12">
                            ...
                            <div>
                                <h5 className="mt-1 mb-2 text-xl dark:text-white">
                                    {item.title}
                                </h5>
